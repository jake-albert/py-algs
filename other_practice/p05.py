...
#   4. 암호화된 배열은 지도의 각 가로줄에서 벽 부분을 1, 공백 부분을 0으로 부호화했을 때 얻어지는 이진수에 해당하는 값의 
#      배열이다.
#
...
# "지도 1 또는 지도 2 중 어느 하나라도 벽인 부분은 전체 지도에서도 벽이다"라는 것으로 비트 연산인 OR를 사용하면 된다는 것을 알
# 수 있습니다. 코멘트는 모두 영어로 작성했습니다. 
